...
//	}
	...
	function drawHoursMinutes(dc) {
		...
		var halfDCHeight = (dc.getHeight() / 2) /* + mAdjustY */ -8 ; // Minus 8 to adjust height so that icons can be displayed at the bottom 
		...
		//x -= 20 ; // Plus 20 pixels to set more space between H and M
		//Sys.println("xH :"+x);	
		// Draw hours
		//dc.setColor(gHoursColour, Graphics.COLOR_TRANSPARENT);
		//var x = 0;
		//dc.setColor(Graphics.COLOR_DK_GRAY, Graphics.COLOR_TRANSPARENT);
		dc.setColor(gHoursColor, Graphics.COLOR_TRANSPARENT);
		dc.drawText(
			x, 
			halfDCHeight,
			//85,
		...
		//x += 40; // Plus 20 pixels to compensate H translation
		//Sys.println("xM :"+x);
		
		// Draw minutes
		//dc.setColor(gMinutesColour, Graphics.COLOR_TRANSPARENT);
		//dc.setColor(Graphics.COLOR_WHITE, Graphics.COLOR_TRANSPARENT);
		dc.setColor(gMinutesColor, Graphics.COLOR_TRANSPARENT);
		dc.drawText(
			x,
			//145,
			halfDCHeight,
